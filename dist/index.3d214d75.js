...
const showDeleteBtn = (id)=>{
    ...
    deleteBtn.addEventListener("click", _.throttle(()=>{
        ...
        if (document.getElementById(id).id < 26) (0, _notiflixNotifyAio.Notify).info("Elementy początkowe nie mogą być usunięte permamentnie z listy. Usuwanie ich może doprowadzić do duplikacji");
...
const addElement = ()=>{
    ...
    hideModal();
    handleDeleteBtn();
    (0, _notiflixNotifyAio.Notify).success("Pomyślnie dodane nap\xf3j");
};
const hideModal = ()=>{
...
const deleteElement = (id)=>{
    ...
    document.addEventListener("click", (e)=>{
        if (e.target === deleteCancelBtn) deletePopupEl.style.display = "none";
            ...
            deletePopupEl.style.display = "none";
            if (+drinkToDelete.id > 25) (0, _notiflixNotifyAio.Notify).success("Usunięto permamentnie.");
...
clearStorageBtn.addEventListener("click", ()=>{
    ...
    document.addEventListener("click", (e)=>{
        if (e.target === deletePermamentBtn) {
            localStorage.clear();
            deletePopupEl.style.display = "none";
            (0, _notiflixNotifyAio.Notify).success("Pamięć lokalna usunięta. Strona zostanie przywr\xf3cona do stanu pierwotnego po odświerzeniu.");
